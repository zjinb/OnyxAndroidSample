...
import static com.onyx.deskclock.deskclock.provider.ClockContract.AlarmsColumns;
import static com.onyx.deskclock.deskclock.provider.ClockContract.InstancesColumns;
import static com.onyx.deskclock.deskclock.provider.ClockDatabaseHelper.ALARMS_TABLE_NAME;
import static com.onyx.deskclock.deskclock.provider.ClockDatabaseHelper.INSTANCES_TABLE_NAME;
...
//    private static final Map<String, String> sAlarmsWithInstancesProjection = new ArrayMap<>();
    private static final Map<String, String> sAlarmsWithInstancesProjection = new HashMap<>();
    static {
