...
//    private final ArrayMap<Integer, MenuItemController> mControllers;
    private final HashMap<Integer, MenuItemController> mControllers;
...
//        }
        ...
        for (Map.Entry entry : mControllers.entrySet()){
            MenuItemController controller = (MenuItemController) entry.getValue();
            if (controller.isEnabled()){
