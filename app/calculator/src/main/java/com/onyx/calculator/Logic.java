...
class Logic {
    ...
    private void clearWithHistory(boolean scroll) {
        ...
        if (MARKER_EVALUATE_ON_RESUME.equals(text)) {
            ...
            evaluateAndShowResult(text, CalculatorDisplay.SCROLL_NONE);
        } else {
            mResult = "";
            mDisplay.setText(
                    text, scroll ? CalculatorDisplay.SCROLL_UP : CalculatorDisplay.SCROLL_NONE);
            mIsError = false;
        }
    }
    ...
    private void clear(boolean scroll) {
        mHistory.enter("");
        mDisplay.setText("", scroll ? CalculatorDisplay.SCROLL_UP : CalculatorDisplay.SCROLL_NONE);
        cleared();
    }
    ...
    public void evaluateAndShowResult(String text, @CalculatorDisplay.Scroll int scroll) {
        try {
    ...
    void onUp() {
        ...
        if (mHistory.moveToPrevious()) {
            mDisplay.setText(mHistory.getText(), CalculatorDisplay.SCROLL_DOWN);
        }
    }
    ...
    void onDown() {
        ...
        if (mHistory.moveToNext()) {
            mDisplay.setText(mHistory.getText(), CalculatorDisplay.SCROLL_UP);
        }
    }
