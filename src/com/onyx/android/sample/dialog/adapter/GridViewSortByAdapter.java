 ...
 *
 */
package com.onyx.android.sample.dialog.adapter;
...
public class GridViewSortByAdapter extends OnyxPagedAdapter
{
            ...
            SortOrder[] orders)
    {
        ...
        this.getPageLayout().setItemMinHeight((int)context.getResources().getDimension(R.dimen.sort_by_dialog_item_height));
        this.getPageLayout().setItemThumbnailMinHeight((int)context.getResources().getDimension(R.dimen.sort_by_dialog_item_height));
        this.getPageLayout().setItemDetailMinHeight((int)context.getResources().getDimension(R.dimen.sort_by_dialog_item_height));
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        case Size:
            ...
            break;
        case CreationTime:
            textView.setText(R.string.By_Creation_Time);
            break;
        default:
