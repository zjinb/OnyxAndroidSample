...
public class OnyxFileGridView extends LinearLayout
{
    ...
    public void onPrepareMultipleSelection()
    {
        ...
        EpdController.invalidate(OnyxFileGridView.this, UpdateMode.GU);
    }
    ...
    private void init(Context context)
    {
        ...
        mButtonCancel.setOnClickListener(new View.OnClickListener()
        {
            ...
            { 
                ...
                if (((GridItemBaseAdapter) mGridView.getPagedAdapter()).isInMultipleSelectionMode() == true) {
        ...
        mButtonPaste.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                CopyService.clean();
                EpdController.invalidate(mButtonCancel, UpdateMode.GU);
            }
        });
