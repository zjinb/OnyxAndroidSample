...
public class FileIconFactory
{
    ...
    /**
     * never return null, should init() first
     * 
     * @param fileName
     * @return
     */
    public static synchronized Bitmap getIconByFileName(Context context, String fileName)
    {
        if (!ourInited) {
            init(context);
        }
    ...
    {
        icons.put(fileExtension.toUpperCase(Locale.getDefault()), resourceId);
    }
    ...
    private static String getFileExtension(String fileName)
    {
        ...
        if (idx == -1) {
            ...
            return fileName.substring(idx).toUpperCase(Locale.getDefault());
        }
    }
}
